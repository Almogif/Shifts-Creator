...
def button_callback2():
    ...
    ws['A1'].fill = GradientFill(stop=("00CCFFFF", "0099CCFF"))
    ws['B1'].fill = GradientFill(stop=("00CCFFCC", "00FFFF99"))
    ws['C1'].fill = GradientFill(stop=("00CCFFFF", "0099CCFF"))
    ws['D1'].fill = GradientFill(stop=("00CCFFCC", "00FFFF99"))
    ws['E1'].fill = GradientFill(stop=("00CCFFFF", "0099CCFF"))
    ws['F1'].fill = GradientFill(stop=("00CCFFCC", "00FFFF99"))
    ws['G1'].fill = GradientFill(stop=("00CCFFFF", "0099CCFF"))
    ws['H1'].fill = GradientFill(stop=("00CCFFCC", "00FFFF99"))
    ws['I1'].fill = GradientFill(stop=("00CCFFFF", "0099CCFF"))
    ws['J1'].fill = GradientFill(stop=("00CCFFCC", "00FFFF99"))
    ws['K1'].fill = GradientFill(stop=("00CCFFFF", "0099CCFF"))
    ws['L1'].fill = GradientFill(stop=("00CCFFCC", "00FFFF99"))
