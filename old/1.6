...
def button_callback2():
    ...
    for x in range(0, 9999):
        hello = ""
        if A:
            hello = hello + " " + random.choice(A)
        else:
            hello = hello + " " + "A"
        if B:
            hello = hello + " " + random.choice(B)
        else:
            hello = hello + " " + "B"
        if C:
            hello = hello + " " + random.choice(C)
        else:
            hello = hello + " " + "C"
        if D:
            hello = hello + " " + random.choice(D)
        else:
            hello = hello + " " + "D"
        if E:
            hello = hello + " " + random.choice(E)
        else:
            hello = hello + " " + "E"
        if F:
            hello = hello + " " + random.choice(F)
        else:
            hello = hello + " " + "F"
        if G:
            hello = hello + " " + random.choice(G)
        else:
            hello = hello + " " + "G"
        if H:
            hello = hello + " " + random.choice(H)
        else:
            hello = hello + " " + "H"
        if I:
            hello = hello + " " + random.choice(I)
        else:
            hello = hello + " " + "I"
        if J:
            hello = hello + " " + random.choice(J)
        else:
            hello = hello + " " + "J"

        hello = hello.split(" ")
        hello.pop(0) # last str remove
        if (hello.count('alyona') == 2) and (hello.count('alex') == 1) and (
            ...
            break
        elif (hello.count('alyona') == 1) and (hello.count('alex') == 1) and (hello.count('ofir') == 1) and (
                hello.count('yair') == 1) and (hello.count('almog') == 1) and (hello.count('pavel') == 2) and (
