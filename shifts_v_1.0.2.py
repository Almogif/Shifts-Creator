...
def button_callback2():
    ...
    for x in range(0, 9999):
        ...
        hello = hello.split(" ")
        if (hello.count('empty') <= 2) and (hello.count('alyona') == 1) and (hello.count('alex') == 1) and (
                hello.count('ofir') == 1) and (hello.count('yair') == 1) and (hello.count('almog') == 2) and (
                hello.count('pavel') == 1) and (hello.count('ran') == 2) and (hello.count('sahar') == 1):
            break
        elif (hello.count('alyona') == 1) and (hello.count('alex') == 2) and (hello.count('ofir') == 1) and (
                hello.count('yair') == 2) and (hello.count('almog') == 1) and (hello.count('pavel') == 1) and (
                hello.count('ran') == 1) and (hello.count('sahar') == 1):
            break
        elif (hello.count('alyona') == 2) and (hello.count('alex') == 1) and (hello.count('ofir') == 1) and (
                hello.count('yair') == 1) and (hello.count('almog') == 1) and (hello.count('pavel') == 1) and (
                hello.count('ran') == 1) and (hello.count('sahar') == 2):
            break
    ws['A2'] = (hello[0])
    ws['A3'] = (hello[1])
    ws['A4'] = (hello[2])
    ...
    ws['A1'].fill = fill = GradientFill(stop=("00CCFFFF", "FFFFFF"))
    ws['B1'].fill = fill = GradientFill(stop=("00CCFFCC", "FFFFFF"))
    ws['C1'].fill = fill = GradientFill(stop=("00CCFFFF", "FFFFFF"))
    ws['D1'].fill = fill = GradientFill(stop=("00CCFFCC", "FFFFFF"))
    ws['E1'].fill = fill = GradientFill(stop=("00CCFFFF", "FFFFFF"))
    ws['F1'].fill = fill = GradientFill(stop=("00CCFFCC", "FFFFFF"))
    ws['G1'].fill = fill = GradientFill(stop=("00CCFFFF", "FFFFFF"))
    ws['H1'].fill = fill = GradientFill(stop=("00CCFFCC", "FFFFFF"))
    ws['I1'].fill = fill = GradientFill(stop=("00CCFFFF", "FFFFFF"))
    ws['J1'].fill = fill = GradientFill(stop=("00CCFFCC", "FFFFFF"))
    ws['K1'].fill = fill = GradientFill(stop=("00CCFFFF", "FFFFFF"))
    ws['L1'].fill = fill = GradientFill(stop=("00CCFFCC", "FFFFFF"))
    wb.save('sample.xlsx')
