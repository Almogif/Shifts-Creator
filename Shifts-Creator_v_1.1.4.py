...
def check():
    ...
    if 'alyona' in st.values:
        ...
        print("alyona sat last week")
    if 'alex' in st.values:
        alex = alex + "ABCDEGI"
        print("alex sat last week")
    if 'ofir' in st.values:
        ofir = ofir + "ABCD"
        print("ofir* sat last week")
    if 'yair' in st.values:
        yair = yair + "ABCDEGI"
        print("yair sat last week")
    if 'almog' in st.values:
        almog = almog + "ABCDEGI"
        print("almog sat last week")
    if 'ran' in st.values:
        ran = ran + "ABCDEGI"
        print("ran sat last week")
    if 'sahar' in st.values:
        sahar = sahar + "ABCDEGI"
        print("sahar sat last week")
    if 'pavel' in st.values:
        pavel = pavel + "ABCDEGI"
        print("pavel sat last week")
