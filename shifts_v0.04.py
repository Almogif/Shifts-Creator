...
def button_callback2():
    ...
    while True:
        ...
        hello = hello.split(" ")
        if (hello.count('alyona') == 1) and (hello.count('alex') == 1) and (hello.count('ofir') == 1) and (hello.count('yair') == 1) and (hello.count('almog') == 2) and (hello.count('pavel') == 1) and (hello.count('ran') == 2) and (hello.count('sahar') == 1):
            break
