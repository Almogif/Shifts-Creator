...
def button_callback():
    ...
    label_2 = tkinter.Label(frame_1, text=" " + (optionmenu_1.get()) + " can not work on " + (combobox_1.get()) + " ")
...
def button_clear():
    ...
    label_5 = Label(master=frame_1, text=("You have clear all request"))
...
label_1 = Label(master=frame_1, text="Shifts Creator", justify=tkinter.LEFT)
...
button_1 = Button(master=frame_1, text="save", command=button_callback)
button_1.pack(pady=12, padx=10)

button_2 = Button(master=frame_1, text="finished", command=button_callback2)
button_2.pack(pady=12, padx=10)

button_3 = Button(master=frame_1, text="Clear all", command=button_clear)
button_3.pack(pady=10, padx=8)

label_3 = Label(master=frame_1, text="Shifts blocked:", justify=tkinter.LEFT)
